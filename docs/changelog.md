...
???+ note "Version 2.9"
	* May 26, 2026, API Version 2.9.5
		...
		* Add additional params (`blocks`, `daily_indices`, `hourly_indices`, `day_night_indices`) for a future MCP server per [PR #566 566](https://github.com/Pirate-Weather/pirate-weather-code/pull/566);
	...
	* February 12, 2026, API Version 2.9.2
		...
		* Update dependencies to use Pandas 3.0/ eccodes 2.45.0/ wgrib2-3.7.0
	...
	* December 24, 2025, API Version 2.9.0
		...
		* Refactor the codebase to break out the functions and simplify the code as per [PR #438](https://github.com/Pirate-Weather/pirate-weather-code/pull/438).
